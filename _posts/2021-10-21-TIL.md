...
２. Manipulation of resources through representations (CRUD 명령시 메세지에 명시해야한다.)
...
결국 <span style="color:#DC143C">**독립적인 진화</span> 로이 필딩이 REST를 만든 궁극적인 이유이다.
...
- JSON, XML등을 이용하는 메세지 구조로 <span style="color:#4682B4">**해당 메세지가 무엇을, 어떤 행위를 의미하는지**</span>
...
### 💡 ***REST API란?***
RESPT API란 REST의 원리를 따르는 API를 의미한다. 그리고 지켜야하는 규칙이 있다.
